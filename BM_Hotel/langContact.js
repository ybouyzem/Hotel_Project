...
var data = {
    ...
    "arabic":
    {
        "BigTitle": "تواصل معنا",
        "miniTitle1": "اتصل بنا",
        "miniTitle2": "البريد الإلكتروني",
        "miniTitle3": "الموقع",
        "FormTitle": "ادخل في محادثة",
        "FormFullName": "الاسم الكامل",
        "FormEmail": "البريد الإلكتروني",
        "FormMessage" : "اكتب رسالتك هنا...",
        "MediaTitle" : "تفضل بزيارتنا هنا",
        "MediaWebInstagram" : "انستغرام",
        "MediaWebFacebook" : "فيسبوك",
        "MediaWebYoutube" : "يوتيوب",
        "MediaWebLinkedIn" : "ينكدين",
    },
}